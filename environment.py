...
class Environment(object):
    ...
    def __init__(self):
        # add variable to keep track of successful trip  
        self.success = 0
    ...
    def act(self, agent, action):
        ...
        if agent is self.primary_agent:
            if state['location'] == state['destination']:
                ...
                print 'Number of successes so far: {}'.format(self.success)
    ...
    def print_counts(self):
        ...
        print self.reached_count
        
    # create function to return the number of successes
